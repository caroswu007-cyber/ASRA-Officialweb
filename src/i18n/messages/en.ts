...
export const messagesEn: Record<string, string> = {
  ...
  'home.truth.abstractBody':
    'Through systematic exploration and firsthand experiential evidence, we have explored the ethereal world and life in many areas. The Woos Ethereal Life & Realm Documentary Series reveals it all.',
  'home.truth.videoTitle': 'Video Document Series',
  'home.truth.videoSubtitle':
    'Document series across multiple dimensions and uncover the truths based on dedicated research.',
  ...
  'home.truth.s3.description':
    'This documentary presents evidence for the existence of the Universal Matrix of Meta Awareness. It has created three types of virtual survival environments for humanity, controls human free consciousness, the evolution of life on Earth, and the ultimate destiny of human civilization.',
  ...
  'spirit.filmedCatalogLead':
    'Below: Season II episodes that are already filmed and published on the official playlist. This block is the episode index and viewing order for what has been shot.',
  ...
  'founderStory.storylineClipLead':
    '**Stage {{stage}}** on the original storyline: the same YouTube session is embedded below. For full context see',
  ...
  'matrix.season3FilmingNote': 'To date, only one episode of Series III has been filmed.',
  'matrix.indexSummary': '{{files}} files — file-level index',
  'matrix.watchOnYoutube': 'Watch on YouTube',
